...
function renderMarkdown(date, results) {
  const lines = [
    ...
    "## 발행 전 정보 품질 기준",
    "",
    "- 검색 결과는 질문 발굴에만 쓰고, 날짜·시간·금액·대상·장소는 주최기관·정부·공식 예매처 등 1차 출처로 검증합니다.",
    "- `공식 일정표를 확인하세요`, `달라질 수 있습니다` 같은 문장만으로 표나 절을 채우지 않습니다.",
    "- 일정 글은 최소한 기간·운영시간·정확한 장소·요금·문의처·확정 프로그램을 제공합니다.",
    "- 세부정보가 미공개라면 미공개 항목과 확인 기준일을 명시하고, 과거 행사나 예상 내용으로 분량을 채우지 않습니다.",
    "- 제목에서 약속한 정보가 본문에 실제 수치와 사실로 제공되는지 최종 대조합니다.",
    "- 공식 근거가 부족한 절은 짧게 줄이거나 삭제합니다.",
    ""
  ];
