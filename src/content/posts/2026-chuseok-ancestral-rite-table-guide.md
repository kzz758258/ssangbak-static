...
*▲ 신위와 가까운 안쪽부터 메·갱·잔·수저, 적·전, 탕, 포·나물·김치·식혜, 과일을 놓은 대표적인 5열 상차림 예시입니다.*

위 이미지는 전통 상차림의 구성을 이해하기 위한 참고 예시입니다. 모시는 조상의 수에 따라 밥·국·잔·수저의 수가 달라질 수 있고, 추석에는 집안 전통에 따라 밥 대신 송편을 중심으로 차리기도 합니다. 생선 방향과 과일 순서도 지역과 가문마다 다르므로 사진을 그대로 복제하기보다 **음식군이 놓이는 대략적인 줄과 가족이 이어온 방식**을 함께 확인하세요.
